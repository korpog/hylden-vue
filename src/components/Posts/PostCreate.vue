  ...
  <div class="signup w-75 p-2 mx-auto">
    ...
    <b-form @submit="onSubmit">
      <b-form-group id="input-group-1" label="Category" label-for="input-1">
        <b-form-select v-model="form.category" :options="categories" required></b-form-select>
      </b-form-group>

      <b-form-group id="input-group-2" label="Title" label-for="input-2">
        <b-form-input id="input-2" v-model="form.title" required placeholder="title"></b-form-input>
      </b-form-group>
